...
{% include image.html url="/assets/images/no_padding_strides_transposed_single-1.png" description="Figure 2: Transposed Convolution without any overlap (no padding)." %}
...
{% include image.html url="/assets/images/fix_one_deconv_boat.png description="Figure 3: Artefacts in an image generated by a neural network." %}
...
### Baseline
{% include image.html url="/assets/images/cifar10-baseline.png" description="Figure 8: Cifar10 Baseline Results." %}

{% include image.html url="/assets/images/MNIST-baseline.png" description="Figure 9: MNIST Baseline Results." %}

The baseline images for Cifar10 are too blurred and unusable as an autoencoder.
### Feature Loss
{% include image.html url="/assets/images/cifar10-featureloss.png" description="Figure 10: Cifar10 Feature Loss Results." %}

{% include image.html url="/assets/images/MNIST-featureloss.png" description="Figure 11: MNIST Feature Loss Results." %}
...
### Pretraining
#### Pretrained Weights
{% include image.html url="/assets/images/cifar10-pretrained.png" description="Figure 12: Cifar10 Pretrained Results." %}

{% include image.html url="/assets/images/MNIST-pretrained.png" description="Figure 13: MNIST Pretrained Results." %}
...
#### Resnet Model
{% include image.html url="/assets/images/cifar10-resnet.png" description="Figure 14: Cifar10 Resnet Results." %}

{% include image.html url="/assets/images/MNIST-resnet.png" description="Figure 15: MNIST Resnet Results." %}
...
### Pixel Shuffle
{% include image.html url="/assets/images/cifar10-pixelshuffle.png" description="Figure 16: Cifar10 Pixel Shuffle Results." %}

{% include image.html url="/assets/images/MNIST-pixelshuffle.png" description="Figure 17: MNIST Pixel Shuffle Results." %}
...
### Progressive Resizing
{% include image.html url="/assets/images/cifar10-progresize.png" description="Figure 19: Cifar10 Progressive Resizing Results." %}

{% include image.html url="/assets/images/MNIST-progresize.png" description="Figure 19: MNIST Progressive Resizing Results." %}
